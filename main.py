...
if __name__ == "__main__":
    ...
    # model_train(network_class=model, out_dict_dir="model_pth", epoch=20, n=20)
    ...
    static_quant(is_test=False, in_dict_path="./model_pth/model_dict_20.pth",
                 out_dict_path="./model_pth/model_int8.pth", network_class=model,
                 network_class_quant=model_quant)
    # 模型参数(weight、bias)导出为txt和vivado支持的coe rom file, 并通过字典获取后续需要的量化参数(scale及zero_point)
    quant_dict = {}
